...
import { signInWithEmail, signUpWithEmail, signInWithGoogle, signInWithGithub, db } from '../firebase';
  ...
  const socialButtons = (prefix) => (
    <>
      ...
      <div className="auth-socials">
        ...
        <button type="button" className="auth-social-btn" id={`${prefix}-github-btn`} onClick={handleGithubSignIn} disabled={isSubmitting}>
